...
ColumnLayout {
    ...
    RowLayout {
        ...
        Label {
            ...
            color: root.mlBridge.segmentFemPt.length > 0 ? Theme.fg : Theme.fgMuted
            font.pixelSize: Theme.caption
            text: root.mlBridge.segmentFemPt.length > 0 ? baseName(root.mlBridge.segmentFemPt) : qsTr("not set")
        }
    ...
    RowLayout {
        ...
        Label {
            Layout.fillWidth: true
            elide: Text.ElideMiddle
            color: root.mlBridge.segmentTibPt.length > 0 ? Theme.fg : Theme.fgMuted
            font.pixelSize: Theme.caption
            text: root.mlBridge.segmentTibPt.length > 0 ? baseName(root.mlBridge.segmentTibPt) : qsTr("not set")
        }
    ...
    RowLayout {
        ...
        Label {
            Layout.fillWidth: true
            elide: Text.ElideMiddle
            color: root.mlBridge.estimatePt.length > 0 ? Theme.fg : Theme.fgMuted
            font.pixelSize: Theme.caption
            text: root.mlBridge.estimatePt.length > 0 ? baseName(root.mlBridge.estimatePt) : qsTr("not set")
        }
    ...
    RowLayout {
        ...
        Button {
            ...
            text: qsTr("Segment")
            Layout.fillWidth: true
            enabled: !root.runLocked && root.studyBridge.hasDataset && root.studyBridge.currentFrame >= 0 && root.mlBridge.hasSegmentModel
        ...
        Button {
            ...
            text: qsTr("Estimate")
            Layout.fillWidth: true
            enabled: !root.runLocked && root.studyBridge.hasDataset && root.studyBridge.currentFrame >= 0 && root.studyBridge.primaryModelIndex >= 0 && root.mlBridge.hasEstimateModel && root.mlBridge.hasSegmentModel
    ...
    Label {
        ...
        font.pixelSize: Theme.caption
        wrapMode: Text.Wrap
        text: qsTr("Estimate needs a segmentation model too — pick a " + "femur or tibia .pt first.")
    }
    ...
    RowLayout {
        ...
        CheckBox {
            ...
            contentItem: Text {
                ...
                leftPadding: blackSilCheck.indicator ? blackSilCheck.indicator.width + blackSilCheck.spacing : 0
            }
