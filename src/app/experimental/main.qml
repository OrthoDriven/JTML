...
Window {
    ...
    readonly property bool shellDirty: settingsBridge.dirty || poseBridge.dirty
    ...
    Dialog {
        ...
        contentItem: Label {
            text: qsTr("Loading a new image set replaces the current dataset " + "(frames and models). The calibration stays loaded. " + "Continue?")
            wrapMode: Text.Wrap
        }
    ...
    Dialog {
        ...
        onAccepted: {
            ...
            if (discardDialog.pendingDialog === poseDialog && poseDialog.prepareDiscard)
        ...
        contentItem: Label {
            text: qsTr("This dialog has unsaved changes. " + "Discard them?")
            wrapMode: Text.Wrap
        }
    ...
    ColumnLayout {
        ...
        Toolbar {
            ...
            onShowMessageRequested: (t, m) => {
                return showMessage(t, m);
            }
